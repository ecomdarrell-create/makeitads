      ...
      <div className="space-y-5 sm:space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:gap-5">
          ...
          <div className="flex-1">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white leading-tight no-hyphens break-words">
          ...
          <div className="flex gap-2 sm:gap-3">
            <div className="flex-1 rounded-xl border border-white/10 bg-[#0f0f1a] p-3 sm:p-4 min-w-0">
              <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
                <div className="h-6 w-6 sm:h-7 sm:w-7 rounded-lg bg-[#6366f1]/10 flex items-center justify-center flex-shrink-0">
                  <svg className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-[#8b5cf6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <span className="text-[10px] sm:text-xs text-slate-400 font-medium truncate">Strategies</span>
              </div>
              <p className="text-lg sm:text-xl font-bold text-white no-hyphens">0/1</p>
            ...
            <button className="rounded-xl border border-white/10 bg-[#0f0f1a] p-3 sm:p-4 flex items-center justify-center hover:bg-white/5 transition-colors active:scale-95 flex-shrink-0">
        ...
        >
          <div className="flex items-start gap-3 sm:gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <h3 className="text-sm sm:text-lg font-semibold text-white mb-2 sm:mb-3 break-words leading-tight">
