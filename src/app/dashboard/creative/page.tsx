...
const enrichedBrief = {
  ...
  layoutExamples: [
    { 
      title: "Hero Banner", 
      desc: "Product centered, bold headline on left, CTA on right. Dark background." 
    },
    { 
      title: "Carousel Ad", 
      desc: "5 slides. Slide 1: Hook. Slide 2-4: Benefits. Slide 5: Social Proof + CTA." 
    },
    { 
      title: "Story Format", 
      desc: "Full-screen video. Fast cuts (2s). Text overlays in center. Trending audio." 
    }
  ]
};
...
const sectorTemplates = [
  { 
    ...
    icon: Heart, 
    desc: "Soft lighting, clean aesthetics, focus on texture." 
  },
  { 
    name: "SaaS & Tech", 
    icon: Cpu, 
    desc: "Dark mode UI shots, bold gradients, clear value prop." 
  },
  { 
    name: "E-commerce & Fashion", 
    icon: ShoppingBag, 
    desc: "Lifestyle shots, dynamic angles, seasonal vibes." 
  },
  { 
    name: "Food & Beverage", 
    icon: Utensils, 
    desc: "Macro shots, vibrant colors, appetite-inducing." 
  },
  { 
    name: "B2B Services", 
    icon: Briefcase, 
    desc: "Professional, trust-building, data-driven visuals." 
  },
];
...
export default function CreativeStudioPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">
            Agency-grade visual briefs and creative direction
          </p>
        </div>
        {isLocked && (
      ...
      {/* Section 1: Visual Brief (Accessible à tous) */}
      <div>
      ...
      {/* Section 2: Sector Templates (Premium) */}
          ...
          <div className="absolute inset-0 z-10 flex items-center justify-center rounded-2xl bg-[#0f0f1a]/60 backdrop-blur-md">
            <div className="text-center px-4">
              ...
              <p className="text-lg font-bold text-white mb-2">
                Agency-Grade Templates
              </p>
              <p className="text-sm text-slate-400 mb-4">
                Access pre-built creative briefs for your specific industry.
              </p>
        ...
        <div className={isLocked ? "blur-sm select-none pointer-events-none" : ""}>
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-base font-bold text-white">
              Creative Brief Library by Sector
            </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {sectorTemplates.map((template) => {
              ...
              return (
                <div 
                  key={template.name} 
                  className="group rounded-xl border border-white/10 bg-[#0f0f1a] p-5 hover:border-[#6366f1]/30 transition-all cursor-pointer"
                >
      ...
      {/* Section 3: AI Visual Generation (Premium) */}
        ...
        {isLocked && (
          <div className="absolute inset-0 z-10 flex items-center justify-center rounded-2xl bg-[#0f0f1a]/60 backdrop-blur-md">
            <div className="text-center px-4">
              ...
              <p className="text-sm text-slate-400 mb-4">
                Generate actual ad creatives directly from your briefs.
              </p>
              <button className="rounded-xl bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] px-6 py-2.5 text-sm font-bold text-white shadow-lg shadow-[#6366f1]/30 hover:scale-105 transition-transform">
                Upgrade to Premium
              </button>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-300">
                We're integrating Replicate to let you generate high-converting 
                ad images directly from your text briefs.
              </p>
            </div>
          </div>
        </div>
