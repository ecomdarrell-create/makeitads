  ...
  return (
    <section className="relative z-10 min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#080810]/50 via-[#080810]/30 to-[#080810]/70" />
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 backdrop-blur-md px-4 py-1.5 text-xs font-medium text-slate-200 mb-8"
        >
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-slate-200 mb-10 leading-relaxed max-w-3xl mx-auto"
        >
        ...
        >
          ...
          <a
            href="#walkthrough"
            className="flex items-center gap-2 rounded-full border border-white/20 bg-white/10 backdrop-blur-md px-8 py-3.5 text-sm font-semibold text-white hover:bg-white/20 transition-all"
          >
            See How It Works
          </a>
        </motion.div>
