...
import { CheckCircle2, X, ShieldCheck, TrendingUp } from "lucide-react";

// ✅ AVIS CORRIGÉS : Cohérence parfaite Genre/Prénom + Professions réelles
const PREMIUM_SUCCESS_STORIES = [
  {
    ...
    name: "Aminata D.", company: "Gérante de boutique, Abidjan", 
  ...
  },
  {
    ...
    name: "Moussa K.", company: "Directeur d'agence digitale, Dakar", 
  ...
  },
  {
    ...
    name: "Fatima S.", company: "Fondatrice, Cosmétiques naturels, Cotonou", 
  ...
  },
  {
    ...
    name: "Koffi A.", company: "Promoteur immobilier, Abidjan", 
  ...
  },
  {
    ...
    name: "Sophie L.", company: "Coach sportif, Yaoundé", 
  ...
  },
  {
    ...
    avatar: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&h=150&fit=crop&crop=face", // Homme (Corrigé)
    name: "Marc T.", company: "Graphiste freelance, Douala", 
  ...
  },
  {
    ...
    name: "Awa N.", company: "Consultante marketing, Dakar", 
  ...
  },
  {
    ...
    avatar: "https://images.unsplash.com/photo-1537368910025-700350fe46c7?w=150&h=150&fit=crop&crop=face", // Homme (Corrigé)
    name: "Dr. Koné A.", company: "Médecin, Clinique Santé Plus, Bamako", 
  ...
  },
  {
    ...
    name: "Clara M.", company: "Commerçante, Wax Chic, Lomé", 
  ...
  },
  {
    ...
    name: "Patrick L.", company: "Agent immobilier, Libreville", 
  ...
  },
  {
    ...
    name: "Grace K.", company: "Esthéticienne, Glow Douala", 
  ...
  },
  {
    ...
    name: "Kader D.", company: "Entrepreneur agroalimentaire, Cotonou", 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 mb-8 md:mb-10">
        <div className="flex flex-col items-start md:items-center">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-sm font-medium text-[#18181B] ml-1">4.9 / 5</span>
          </div>
          <h3 className="text-base sm:text-lg font-medium text-[#18181B] mb-2 text-left md:text-center">
          ...
          {duplicatedStories.map((story, index) => (
            ...
            >
              ...
              <div className="text-center">
                <p className="text-[10px] font-medium text-[#18181B]">{story.name.split(" ")[0]}</p>
                <p className="text-[9px] text-[#71717A]">{story.company.split(",")[0]}</p>
              </div>
            </motion.button>
          ))}
        </div>
              ...
              <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-2xl border border-[#E7E7EB] overflow-hidden">
                ...
                <div className="p-5">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    />
                    <div>
                      <h4 className="text-sm font-medium text-[#18181B]">{selectedStory.name}</h4>
                  ...
                  <div className="flex items-center gap-3 pt-3 border-t border-[#E7E7EB]">
                    <div className="flex-1">
                      ...
                      <p className="text-base font-medium text-[#6366F1]">{selectedStory.metric}</p>
                    </div>
