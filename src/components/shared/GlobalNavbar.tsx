  ...
  return (
    <nav className="fixed top-4 left-4 right-4 z-50">
      <div className="max-w-7xl mx-auto">
        <div className="relative flex items-center justify-between rounded-full border border-white/20 bg-[#0a0a14]/90 backdrop-blur-xl px-2 sm:px-3 py-2 shadow-2xl">
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-white/10 via-white/5 to-white/10 pointer-events-none" />
          ...
          <div className="hidden lg:flex items-center gap-1 absolute left-1/2 -translate-x-1/2 z-10">
            ...
            <a
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-sm text-[#8b5cf6] hover:text-[#a78bfa] transition-colors rounded-full hover:bg-white/5"
            >
              Community
          ...
          <div className="flex items-center gap-2 relative z-10">
            {loading ? (
              ...
              <div className="relative" ref={userMenuRef}>
                <button 
                  ...
                  className="flex items-center gap-2 rounded-full bg-white/5 border border-white/20 px-2.5 py-1.5 text-xs sm:text-sm font-semibold text-white hover:bg-white/10 transition-colors"
                >
                ...
                <AnimatePresence>
                  {userMenuOpen && (
                    <motion.div 
                      ...
                      className="absolute right-0 mt-2 w-48 rounded-2xl border border-white/20 bg-[#0f0f1a] shadow-2xl overflow-hidden py-2"
                    >
                      <Link 
                        href="/dashboard" 
              ...
              <>
                <Link 
                  href="/login" 
                  className="hidden sm:flex items-center rounded-full border border-white/20 bg-white/5 px-4 py-1.5 text-sm font-semibold text-white hover:bg-white/10 transition-colors"
                >
                  Sign in
                </Link>
                <Link 
                  href="/signup" 
                  className="flex items-center rounded-full bg-[#8b5cf6] px-4 py-1.5 text-sm font-semibold text-white hover:bg-[#7c3aed] transition-colors shadow-lg shadow-[#8b5cf6]/25"
                >
                  Start Free
                </Link>
              </>
            ...
            <button 
              className="lg:hidden text-white p-1.5 rounded-full hover:bg-white/5 transition-colors" 
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            <div className="rounded-3xl border border-white/20 bg-[#0a0a14]/98 backdrop-blur-xl shadow-2xl overflow-hidden relative">
              ...
              <div className="relative z-10 p-3 space-y-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-between px-4 py-3 text-sm text-[#8b5cf6] hover:text-[#a78bfa] hover:bg-white/5 rounded-2xl transition-colors"
                >
                  <span>Community</span>
                ...
                {!user && (
                  <div className="space-y-2 p-2">
                    <Link 
                      href="/login" 
                      onClick={() => setMobileMenuOpen(false)}
                      className="block w-full text-center rounded-full border border-white/20 bg-white/5 px-4 py-2.5 text-sm font-semibold text-white hover:bg-white/10 transition-colors"
                    >
                      Sign in
                    </Link>
                    <Link 
