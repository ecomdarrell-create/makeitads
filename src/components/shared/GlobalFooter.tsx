        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-1.5 mb-6">
              <span className="text-xl font-bold tracking-tight text-white">Make<span className="text-[#8b5cf6]">ItAds</span></span>
            </Link>
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <input type="email" placeholder="Enter your email" className="flex-1 rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white outline-none focus:border-[#6366f1] transition-colors placeholder:text-slate-600" />
