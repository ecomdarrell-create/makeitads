    ...
    <section ref={sectionRef} className="relative z-10 py-16 md:py-24 px-6 bg-[#080810] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="hidden md:grid grid-cols-4 gap-4">
          {/* Widget 1 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }} className="col-span-2 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
          ...
          {/* Widget 2 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }} className="col-span-1 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
          ...
          {/* Widget 3 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.3 }} className="col-span-1 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
          ...
          {/* Widget 4 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.4 }} className="col-span-2 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
          ...
          {/* Widget 5 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.5 }} className="col-span-1 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
          ...
          {/* Widget 6 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.6 }} className="col-span-1 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
          ...
          {/* Widget 7 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.7 }} className="col-span-1 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
            <CircularGauge value={liveData.marketCoverage} label="Market Coverage" size={100} />
          </motion.div>

          {/* Widget 8 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.8 }} className="col-span-1 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.9 }} className="col-span-4 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-8">
          ...
          {/* Widget 10 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 1.0 }} className="col-span-1 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
          ...
          {/* Widget 11 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 1.1 }} className="col-span-1 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
          ...
          {/* Widget 12 */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 1.2 }} className="col-span-2 rounded-2xl border border-white/10 bg-[#0f0f1a] shadow-sm p-6 hover:border-[#6366f1]/30 transition-all">
...
function MobileWidget({ children }: { children: React.ReactNode }) {
  return (
    <div className="snap-center flex-shrink-0 w-[280px] rounded-2xl border border-white/10 bg-[#0f0f1a] backdrop-blur-sm p-6">{children}</div>
  );
}